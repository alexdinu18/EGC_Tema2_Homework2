...
{
	float ParallProjectionMatrix[4][4] ={0};
...
{
	float PerspProjectionMatrix[4][4] ={0};

	proj_type=true;

	//TODO	
	for(int i=0;i<4;++i)
		PerspProjectionMatrix[i][i]=1;
...
{
	float isometricProjectionMatrix[4][4] ={0};

	isometricProjectionMatrix[0][0]= sqrt(3) / sqrt(6); isometricProjectionMatrix[0][1] = 0;					isometricProjectionMatrix[0][2]= - sqrt(3) / sqrt(6);	isometricProjectionMatrix[0][3]= 0;
	isometricProjectionMatrix[1][0]= 1 / sqrt(6);		isometricProjectionMatrix[1][1] = 2 / sqrt(6);			isometricProjectionMatrix[1][2]= 1 / sqrt(6);			isometricProjectionMatrix[1][3]= 0;
	isometricProjectionMatrix[2][0]= sqrt(2) / sqrt(6); isometricProjectionMatrix[2][1] = -sqrt(2) / sqrt(6);	isometricProjectionMatrix[2][2]= sqrt(2) / sqrt(6);		isometricProjectionMatrix[2][3]= 0;
	isometricProjectionMatrix[3][0]= 0;					isometricProjectionMatrix[3][1] = 0;					isometricProjectionMatrix[3][2]= 0;						isometricProjectionMatrix[3][3]= 1;
